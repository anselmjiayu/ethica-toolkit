...
export default function HomePage() {
  return (
    <>
      ...
      <aside>
        These pages are an effort to create an easy-to-use, easy-to-read, free (free as in <i>libre</i>)
      ...
      <nav>
        ...
        <ol>
          ...
          <li>
          <Link to="http://localhost:5173/view/?view1=la&view2=en&part1=2&part2=2">Part 2 </Link>
          </li>
          <li>
          <Link to="http://localhost:5173/view/?view1=la&view2=en&part1=3&part2=3">Part 3 </Link>
          </li>
          <li>
          <Link to="http://localhost:5173/view/?view1=la&view2=en&part1=4&part2=4">Part 4 </Link>
          </li>
          <li>
          <Link to="http://localhost:5173/view/?view1=la&view2=en&part1=5&part2=5">Part 5 </Link>
          </li>
        </ol>
      </nav>
      <h2>References</h2>
